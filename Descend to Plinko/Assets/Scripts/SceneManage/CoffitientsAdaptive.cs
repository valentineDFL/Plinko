    ...
    internal class CoffitientsAdaptive : GameAdaptive
    {
        ...
        protected override void SetAdaptive()
        {
            ...
            for (int i = _zones.Count - 1; i >= 0; i--)
            {
                ...
                _zones[count].transform.position = new Vector2(width2 - (CameraSize.Width / 2) + (_zones[count].transform.localScale.x / 2) + w, -CameraSize.Height / 2 + (_zones[count].transform.localScale.y / 2));
